...
const Loader = () => {
  return (
    <div className="loader">
      ...
      <svg xmlns="Frontend\src\components\1508299228.svg" fill="none" viewBox="0 0 64 64" height={64} width={64} className="inline-block">
        <path
      ...
      <svg xmlns="Frontend\src\components\1508299228.svg" fill="none" style={{ rotationDuration: '0ms', rotationDirection: 'normal' }} viewBox="0 0 64 64" height={64} width={64} className="inline-block">
        <path
          strokeLinejoin="round"
          strokeLinecap="round"
          strokeWidth={10}
