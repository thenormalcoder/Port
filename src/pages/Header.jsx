...
const Header = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center  mt-16 text-center px-48 mb-14'>
        <img
      ...
      <h2 className='text-white'>I'm a Enthusiastic learner of Data Structures and Algorithms ,MERN Stack and AI/ML Lorem ipsum, dolor sit amet consectetur adipisicing elit. Praesentium optio officia sed, fuga, suscipit atque iusto accusamus ullam amet ducimus error quis ut.</h2>
